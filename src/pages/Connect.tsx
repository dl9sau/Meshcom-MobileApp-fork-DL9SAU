...
import { alertsForMsg } from '../utils/NotifyPrefs';
        ...
        (value) => {
          parseMsg(value).then(async (res) => {
            if (res !== undefined && 'msgTXT' in res) {
              ...
              if (res.fromCall !== curr_call && (!res.msgTXT.startsWith("--")) && canNotify.current && !MsgFilterService.isChannelMsgBlocked(res) && alertsForMsg(res, curr_call)) {
