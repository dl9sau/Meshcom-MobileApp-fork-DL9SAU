...
// FIRST.
//
// That is a feature, not a caveat (DL9SAU): where several ways exist, the one that keeps
// winning IS the way the network actually runs here. The figure measures effective delivery,
// not theoretical participation - the packet-level counterpart to what "Heard via" says
// about stations.
//
